...
export const LOFI_MUSIC_PRESETS: LoFiPreset[] = [
  ...
  },
  {
    ...
    description: 'Bright Rhodes, jazzy guitar, optimistic boom-bap',
    bpm: 92,
    chords: [
  ...
  },
  {
    id: 'dj',
    label: 'Night DJ',
    description: 'Deep house pulse, neon after-hours groove',
    bpm: 100,
    chords: [
      [174.61, 220.0, 277.18, 329.63],
      [155.56, 196.0, 246.94, 311.13],
      [138.59, 174.61, 220.0, 277.18],
      [164.81, 207.65, 246.94, 311.13],
    ],
    bass: [87.31, 77.78, 69.30, 82.41],
    padVolume: 0.05,
    bassVolume: 0.12,
    kickVolume: 0.16,
    hatVolume: 0.045,
  ...
  },
  {
    id: 'sunset',
    label: 'Sunset Drive',
    description: 'Warm synthwave pads, golden-hour nostalgia',
    bpm: 88,
    chords: [
      [220.0, 277.18, 329.63, 415.30],
    ...
    filterPeak: 1080,
    hatSteps: [3, 7, 11, 15],
    bassSteps: [0, 4, 6, 8, 12, 14],
    waveform: 'triangle',
  },
  {
    id: 'coffee',
    label: 'Coffee Shop Jazz',
    description: 'Brushed drums, upright bass, mellow saxophone',
    bpm: 78,
    chords: [
      [196.0, 233.08, 293.66, 349.23],
      [174.61, 220.0, 261.63, 329.63],
      [164.81, 196.0, 246.94, 311.13],
      [146.83, 185.0, 220.0, 277.18],
    ],
    bass: [98.0, 87.31, 82.41, 73.42],
    padVolume: 0.052,
    bassVolume: 0.075,
    kickVolume: 0.08,
    hatVolume: 0.022,
